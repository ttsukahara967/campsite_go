...
func ListCampsitesHandler(db *DBWrap) gin.HandlerFunc {
    return func(c *gin.Context) {
        campsites, err := GetAllCampsites(db.DB)
        if err != nil {
...
func GetCampsiteHandler(db *DBWrap) gin.HandlerFunc {
    return func(c *gin.Context) {
        ...
        campsite, err := GetCampsiteByID(db.DB, id)
        if err != nil {
